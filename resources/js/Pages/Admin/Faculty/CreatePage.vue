        ...
        <div class="flow-root">
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <form class="space-y-8 divide-y divide-gray-200" @submit.prevent="form.post(route('admin.faculties.store'))">
                        <div class="space-y-8 divide-y divide-gray-200">
                            <div>
                                <div>
                                    <h3 class="text-base font-semibold leading-6 text-gray-900">Profile</h3>
                                    <p class="mt-1 text-sm text-gray-500">This information will not be displayed publicly</p>
                                </div>
                            </div>
                            ...
                            <div class="pt-8">
                                ...
                                <div class="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    <div class="grid grid-cols-1 gap-6 sm:col-span-6 sm:grid-cols-6">
                                        ...
                                        <div class="sm:col-span-1">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <InputError v-if="form.errors.title" class="mt-1 text-xs text-red-600">
                                                    {{ form.errors.title }}
                                                </InputError>
                                            </div>
                                        </div>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-1">
                                            <select
                                                ...
                                                name="country"
                                                disabled
                                                class="block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                            >
